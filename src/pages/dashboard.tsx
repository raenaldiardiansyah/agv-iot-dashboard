...
export default function Dashboard() {
  ...
  // ✅ SIMULASI INTERVAL SUDAH DIHAPUS
  // DATA SEKARANG HANYA DARI MQTT
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <GlassCard className="p-8 flex flex-col items-center justify-center min-h-[320px] bg-black/60 relative">
          <div className="absolute top-4 left-4 flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-white/30 uppercase tracking-widest">Sensor: LoadCell_A1</span>
          </div>
        ...
        <GlassCard className="p-8 flex flex-col items-center justify-center min-h-[320px] bg-black/60 relative">
          <div className="absolute top-4 left-4 flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-white/30 uppercase tracking-widest">Sensor: LDR_Ph_02</span>
          </div>
        ...
        <GlassCard className="p-8 flex flex-col items-center justify-center min-h-[320px] bg-black/60 relative">
          <div className="absolute top-4 left-4 flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono text-white/30 uppercase tracking-widest">Cell: Li-Po_4S</span>
          </div>
